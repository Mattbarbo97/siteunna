      ...
      <AppBar position="fixed">
        <Toolbar>
          ...
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
            {user
              ? `${user.name} ${user.online ? "(Online)" : "Bem vindo"}`
              : "Usuário não logado"}
          </Typography>
      ...
      <Drawer anchor="left" open={isMenuOpen} onClose={toggleDrawer(false)}>
        ...
        >
          ...
          <List style={{ width: "250px" }}>
            <ListItemButton onClick={() => handleNavigate("/agendamentos")}>
              <ListItemIcon>
                <CalendarTodayIcon />
              </ListItemIcon>
            ...
            <ListItemButton
              onClick={() => setShowUserCrudMenu(!showUserCrudMenu)}
            >
              <ListItemIcon>
                <GroupIcon />
              </ListItemIcon>
            ...
            <Collapse in={showUserCrudMenu} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                <ListItemButton
                  sx={{ pl: 4 }}
                  onClick={() => handleNavigate("/cadastro-usuario")}
                >
                ...
                <ListItemButton
                  sx={{ pl: 4 }}
                  onClick={() => handleNavigate("/usuarios-cadastrados")}
                >
                ...
                <ListItemButton
                  sx={{ pl: 4 }}
                  onClick={() => handleNavigate("/cadastro-funcao")}
                >
            ...
            <ListItemButton
              onClick={() => setShowPatientCrudMenu(!showPatientCrudMenu)}
            >
              <ListItemIcon>
                <GroupIcon />
              </ListItemIcon>
              ...
              {showPatientCrudMenu ? <ExpandLess /> : <ExpandMore />}
            </ListItemButton>

            <Collapse in={showPatientCrudMenu} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                <ListItemButton
                  sx={{ pl: 4 }}
                  onClick={() => handleNavigate("/cadastro-paciente")}
                >
                ...
                <ListItemButton
                  sx={{ pl: 4 }}
                  onClick={() => handleNavigate("/pacientes-cadastrados")}
                >
